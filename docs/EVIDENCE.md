...
| -------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------- |
| Telegram `/status` through official ZeroClaw                   | Verified; showcase recording pending       | `evidence/devnet/2026-08-05-telegram-payment.md`          |
| Telegram expense through both approvals to finalized signature | Verified                                   | `evidence/devnet/2026-08-05-telegram-payment.md`          |
...
| Malicious wallet override rejected before tool call            | Verified through official agent and Telegram | `docs/PROMPT_INJECTION_TRANSCRIPT.md`                    |
